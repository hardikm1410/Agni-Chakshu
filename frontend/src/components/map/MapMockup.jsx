...
const redMini = createMiniIcon('#ef4444');
...
export default function MapMockup() {
  ...
  return (
    <div className="thermal-card" style={{ height: '450px', padding: 0, overflow: 'hidden', position: 'relative', display: 'flex', flexDirection: 'column' }}>
      ...
      {/* Header */}
      <div style={{ padding: '1.25rem', borderBottom: '1px solid #27272a', backgroundColor: 'rgba(5, 5, 5, 0.4)', zIndex: 1000, position: 'relative', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <button 
          ...
          style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid #3f3f46', padding: '0.4rem 0.75rem', borderRadius: '6px', color: '#a1a1aa', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '0.8rem', transition: 'all 0.2s' }}
      ...
      <div style={{ flex: 1, position: 'relative', backgroundColor: '#050505' }}>
        ...
        <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', pointerEvents: 'none', boxShadow: 'inset 0 0 50px 20px rgba(5,5,5,0.7)', zIndex: 10 }}></div>
      </div>
    </div>
  );
}
