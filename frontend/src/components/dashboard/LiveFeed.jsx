...
const alerts = [
  { id: 1, type: 'critical', text: 'Wildfire risk escalated in Sector Alpha', time: '2m ago', icon: ShieldAlert, color: '#ef4444' },
  ...
  { id: 4, type: 'warning', text: 'Unidentified heat source persistence', time: '2h ago', icon: AlertTriangle, color: '#eab308' },
...
export default function LiveFeed() {
  return (
    <div className="thermal-card" style={{ padding: 0, height: '450px', display: 'flex', flexDirection: 'column' }}>
      <div style={{ padding: '1.5rem', borderBottom: '1px solid #27272a', backgroundColor: 'rgba(5, 5, 5, 0.4)' }}>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '0.5rem' }}>
        {alerts.map(alert => {
          ...
          return (
            <div key={alert.id} style={{ display: 'flex', gap: '1rem', padding: '1rem', borderBottom: '1px solid #27272a', alignItems: 'flex-start' }}>
