  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', position: 'relative' }}>
      ...
      <aside style={{ 
        ...
        <div style={{ padding: '1.5rem', borderBottom: '1px solid #27272a', display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'center', padding: '1rem 2rem' }}>
          <div style={{ position: 'relative' }} ref={dropdownRef}>
            <button 
              ...
              style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', background: 'rgba(20,20,20,0.6)', border: '1px solid #3f3f46', padding: '0.5rem 1rem', borderRadius: '8px', color: '#f4f4f5', cursor: 'pointer', fontFamily: 'inherit' }}
            >
              <div style={{ width: '32px', height: '32px', borderRadius: '50%', backgroundColor: '#ef4444', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'bold' }}>
            ...
            {isDropdownOpen && (
              <div style={{ position: 'absolute', top: 'calc(100% + 0.5rem)', right: 0, width: '220px', backgroundColor: '#18181b', border: '1px solid #27272a', borderRadius: '8px', padding: '0.5rem', boxShadow: '0 10px 15px -3px rgba(0,0,0,0.5)', zIndex: 50 }}>
                <div style={{ padding: '0.5rem 0.75rem', borderBottom: '1px solid #27272a', marginBottom: '0.5rem' }}>
                ...
                <div style={{ height: '1px', backgroundColor: '#27272a', margin: '0.5rem 0' }}></div>
                
                <button onClick={handleLogout} style={{ width: '100%', display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '0.5rem 0.75rem', background: 'none', border: 'none', color: '#ef4444', cursor: 'pointer', borderRadius: '4px', textAlign: 'left', fontFamily: 'inherit' }} onMouseOver={e => e.currentTarget.style.backgroundColor = 'rgba(239,68,68,0.1)'} onMouseOut={e => e.currentTarget.style.backgroundColor = 'transparent'}>
