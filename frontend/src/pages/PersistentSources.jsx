...
const sources = [
  { id: 1, name: 'Refinery Flare 4', type: 'Industrial', avgTemp: '350°C', variance: '+5%', icon: Factory, color: '#eab308' },
          ...
          return (
            <div key={source.id} className="thermal-card" style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                ...
                <span style={{ backgroundColor: '#27272a', color: '#a1a1aa', padding: '4px 8px', borderRadius: '4px', fontSize: '0.8rem', fontWeight: '500' }}>{source.type}</span>
              </div>
              <div>
                ...
                <div style={{ display: 'flex', alignItems: 'baseline', gap: '1rem' }}>
                  ...
                  <span style={{ display: 'flex', alignItems: 'center', gap: '0.25rem', color: source.variance.startsWith('+') ? '#ef4444' : '#10b981', fontSize: '0.9rem', fontWeight: '600' }}>
        ...
        <div style={{ flex: 1, minHeight: 0 }}>
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={intensityData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
              ...
              <Line type="monotone" dataKey="Refinery Flare 4" stroke="#eab308" strokeWidth={3} dot={false} />
