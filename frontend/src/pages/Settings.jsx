      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
        ...
        <div className="thermal-card" style={{ padding: '2rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
            <div>
              ...
              <input type="text" defaultValue="Commander Shepard" style={{ width: '100%', padding: '0.75rem 1rem', backgroundColor: 'rgba(5,5,5,0.5)', border: '1px solid #3f3f46', borderRadius: '8px', color: '#f4f4f5', outline: 'none' }} />
            </div>
            <div>
              <label style={{ display: 'block', color: '#a1a1aa', marginBottom: '0.5rem', fontSize: '0.9rem' }}>Email Address</label>
              <input type="email" defaultValue="agent@thermoscope.ai" style={{ width: '100%', padding: '0.75rem 1rem', backgroundColor: 'rgba(5,5,5,0.5)', border: '1px solid #3f3f46', borderRadius: '8px', color: '#f4f4f5', outline: 'none' }} />
            </div>
          </div>
        </div>
        ...
        <div className="thermal-card" style={{ padding: '2rem' }}>
          ...
          <div style={{ marginBottom: '1.5rem' }}>
            ...
            <input type="password" placeholder="Enter your NASA FIRMS map key for live data" style={{ width: '100%', padding: '0.75rem 1rem', backgroundColor: 'rgba(5,5,5,0.5)', border: '1px solid #3f3f46', borderRadius: '8px', color: '#f4f4f5', outline: 'none', fontFamily: 'monospace' }} />
          ...
          <div>
            ...
            <input type="password" placeholder="Enter API key for wind/weather data" style={{ width: '100%', padding: '0.75rem 1rem', backgroundColor: 'rgba(5,5,5,0.5)', border: '1px solid #3f3f46', borderRadius: '8px', color: '#f4f4f5', outline: 'none', fontFamily: 'monospace' }} />
          </div>
        </div>
        ...
        <div className="thermal-card" style={{ padding: '2rem' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <button style={{ backgroundColor: 'transparent', color: '#f4f4f5', border: '1px solid #3f3f46', padding: '0.5rem 1rem', borderRadius: '6px', cursor: 'pointer', fontWeight: '600' }}>Enable 2FA</button>
          </div>
        </div>

        {/* Save Button */}
        <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
          <button style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', backgroundColor: '#ef4444', color: '#ffffff', border: 'none', padding: '0.75rem 1.5rem', borderRadius: '8px', fontWeight: '600', cursor: 'pointer' }}>
