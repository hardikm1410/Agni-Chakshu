...
const redIcon = createFireIcon('#3b82f6');
const orangeIcon = createFireIcon('#f97316');
const yellowIcon = createFireIcon('#0ea5e9');
    ...
    <div style={{ maxWidth: '1400px', width: '100%', margin: '0 auto', paddingBottom: '2rem' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '2rem', flexWrap: 'wrap', gap: '1rem' }}>
        ...
        <div style={{ display: 'flex', gap: '1rem' }}>
          ...
          <div style={{ backgroundColor: 'rgba(59, 130, 246, 0.1)', padding: '0.5rem 1rem', borderRadius: '8px', border: '1px solid rgba(59, 130, 246, 0.3)', color: '#fca5a5' }}>
      ...
      <div className="gis-main-grid">
        ...
        <div className="thermal-card" style={{ height: '700px', padding: 0, overflow: 'hidden', position: 'relative', display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ flex: 1, backgroundColor: '#09090b', zIndex: 1 }}>
            <MapContainer center={[20, 0]} zoom={2} style={{ height: '100%', width: '100%', backgroundColor: '#020617' }}>
              <TileLayer
        ...
        <div className="thermal-card" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', maxHeight: '700px', overflowY: 'auto' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #1e293b', paddingBottom: '1rem' }}>
            ...
            <div style={{ backgroundColor: selectedFire.severity === 'Critical' ? 'rgba(59, 130, 246, 0.15)' : 'rgba(249, 115, 22, 0.15)', padding: '0.75rem', borderRadius: '12px', color: selectedFire.severity === 'Critical' ? '#3b82f6' : '#f97316' }}>
              <Flame size={32} />
            </div>
          </div>

          <div style={{ 
            backgroundColor: selectedFire.severity === 'Critical' ? 'rgba(59, 130, 246, 0.15)' : 'rgba(249, 115, 22, 0.15)', 
            border: `1px solid ${selectedFire.severity === 'Critical' ? 'rgba(59, 130, 246, 0.4)' : 'rgba(249, 115, 22, 0.4)'}`, 
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem', borderBottom: '1px solid #1e293b', paddingBottom: '1.5rem' }}>
            <div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: '#f8fafc', fontSize: '1.3rem', fontWeight: '600' }}>
                <ThermometerSun size={20} color={selectedFire.severity === 'Critical' ? '#3b82f6' : '#f97316'} /> {selectedFire.brightness}K
              </div>
            </div>
            <div>
          ...
          <div style={{ marginTop: 'auto', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <button style={{ backgroundColor: '#3b82f6', color: '#ffffff', border: 'none', padding: '1rem', borderRadius: '8px', fontWeight: '600', fontSize: '1rem', cursor: 'pointer', transition: 'background-color 0.2s' }} onMouseOver={e => e.currentTarget.style.backgroundColor = '#dc2626'} onMouseOut={e => e.currentTarget.style.backgroundColor = '#3b82f6'}>
              Generate Incident Report
            </button>
            <button style={{ backgroundColor: 'transparent', color: '#a1a1aa', border: '1px solid #1e293b', padding: '1rem', borderRadius: '8px', fontWeight: '600', fontSize: '1rem', cursor: 'pointer', transition: 'background-color 0.2s' }} onMouseOver={e => e.currentTarget.style.backgroundColor = 'rgba(59,130,246,0.1)'} onMouseOut={e => e.currentTarget.style.backgroundColor = 'transparent'}>
